...
export const songData: Record<SongName, SongData> = {
  ...
  'Entrust via 39': {
    ...
    lyricsReading: [
      ...
      'ふあんと そのとまどいも いずれだれかがいのった けしきにかわる',
      'じげんをまたがって うたって みえぬかべを こわすのです',
      'ENTRUST VIA 39 まかせて',
      'あてさきのない はなたばをそえ',
