...
export const songData: Record<SongName, SongData> = {
  唱明者: {
    ...
    lyricReading: `MOSHIMO KARADAGA ARUNONARA SEKAIGOTO DAKISHIMETE
...
KAGAMIGOSHI TAKUSARETA SHOMEIYO
AKUNAKI YOROKOBINI NAMIDAO
HATENAKI KANASHIMINI FUKAI NEMURIWO
KAKIKIRENAI OMOIWA UMIOMEGURI
